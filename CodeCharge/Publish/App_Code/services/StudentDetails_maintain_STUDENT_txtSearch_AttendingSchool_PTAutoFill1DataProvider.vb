...
'Grid SCHOOL Item Class @2-6E1C464D
...
Implements IDataItem
    ...
    Public Sub New()
    SCHOOL_ID = New FloatField("", Nothing)
...
'Grid SCHOOL Data Provider Class Variables @2-AE34B2FE
...
'Grid SCHOOL Data Provider Class GetResultSet Method @2-0A9756E6

    Public Sub New()
        Select_=new TableCommand("SELECT TOP {SqlParam_endRecord} SCHOOL_ID, " & vbCrLf & _
          "SCHOOL_NAME AS SCHOOL_NAME " & vbCrLf & _
          "FROM SCHOOL {SQL_Where} {SQL_OrderBy}", New String(){"expr77","And","keyword78"},Settings.connDECVPRODSQL2005DataAccessObject )
        Count=new TableCommand("SELECT COUNT(*)" & vbCrLf & _
          "FROM SCHOOL", New String(){"expr77","And","keyword78"},Settings.connDECVPRODSQL2005DataAccessObject , true)
    End Sub
...
'Before build Select @2-6B37287A
        Dim E as Exception = Nothing
        Select_.Parameters.Clear()
        CType(Select_,TableCommand).AddParameter("keyword78",Urlkeyword, "","SCHOOL_NAME",Condition.Equal,False)
        Select_.Parameters.Add("expr77","(STATUS=1)")
...
'After execute Select tail @2-E26AD6D9
            Dim i as Integer
