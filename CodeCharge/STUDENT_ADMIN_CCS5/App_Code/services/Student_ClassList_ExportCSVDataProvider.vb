...
'Grid view_Class_Contact_List_0 Data Provider Class Variables @2-293B3B5B
    ...
    Public Expr195  As TextParameter
'End Grid view_Class_Contact_List_0 Data Provider Class Variables

'Grid view_Class_Contact_List_0 Data Provider Class GetResultSet Method @2-B6D5D560

    Public Sub New()
        Select_=new TableCommand("SELECT TOP {SqlParam_endRecord} * " & vbCrLf & _
          "FROM view_Class_Contact_List_04022011 {SQL_Where} {SQL_OrderBy}", New String(){"expr191","And","List_Subject_id192","And","List_SEMESTER193","And","List_SUBJECT_ENROL_STATUS194","And","expr195"},Settings.connDECVPRODSQL2005DataAccessObject )
        Count=new TableCommand("SELECT COUNT(*)" & vbCrLf & _
          "FROM view_Class_Contact_List_04022011", New String(){"expr191","And","List_Subject_id192","And","List_SEMESTER193","And","List_SUBJECT_ENROL_STATUS194","And","expr195"},Settings.connDECVPRODSQL2005DataAccessObject , true)
    End Sub
...
'Before build Select @2-2D80ED93
        Dim E as Exception = Nothing
        Select_.Parameters.Clear()
        CType(Select_,TableCommand).AddParameter("List_Subject_id192",UrlList_Subject_id, "","SUBJECT_ID",Condition.Equal,False)
        CType(Select_,TableCommand).AddParameter("List_SEMESTER193",UrlList_SEMESTER, "","SEMESTER",Condition.BeginsWith,False)
        CType(Select_,TableCommand).AddParameter("List_SUBJECT_ENROL_STATUS194",UrlList_SUBJECT_ENROL_STATUS, "","SUBJ_ENROL_STATUS",Condition.BeginsWith,False)
        CType(Select_,TableCommand).AddParameter("expr195",Expr195, "","STAFF_ID",Condition.Equal,False)
        Select_.Parameters.Add("expr191","(ENROLMENT_YEAR =year(getdate()))")
