<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" isIncluded="True" SSLAccess="False" needGeneration="0" cachingEnabled="False" validateRequest="True" scriptingSupport="Automatic" cachingDuration="1 minutes" isService="False">
	<Components>
		...
		<Link id="12" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" editable="False" name="admin" hrefSource="Admin/AdmProducts.ccp" visible="No" wizardUseTemplateBlock="False">
			<Components/>
			<Events>
<Event name="BeforeShow" type="Server">
<Actions>
<Action actionName="Hide-Show Component" actionCategory="General" id="23" action="Show" conditionType="Parameter" dataType="Text" componentName="admin" condition="Equal" sourceType1="Session" name1="GroupID" sourceType2="Expression" name2="2"/>
</Actions>
</Event>
</Events>
			<LinkParameters/>
		...
		<Link id="8" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Logout" hrefSource="Default.ccp" wizardDefaultValue="Logout" PathID="HeaderLogout" wizardUseTemplateBlock="True" linkProperties="{'textSource':'Logout','textSourceDB':'','hrefSource':'Default.ccp','hrefSourceDB':'','title':'','target':'','name':'','linkParameters':{'0':{'sourceType':'Expression','parameterSource':'\'True\'','parameterName':'Logout'},'length':1,'objectType':'linkParameters'}}">
			<Components/>
			<Events>
				<Event name="BeforeShow" type="Server">
					<Actions>
