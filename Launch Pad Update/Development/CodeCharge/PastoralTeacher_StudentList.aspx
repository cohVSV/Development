...
STATUS</asp:LinkButton> 
                        ...
                        <th>&nbsp;Mandated Cohort&nbsp;<img onclick="javascript:alert('Mandated PLSP cohort details where applicable');return false;" id="LAstudentMandatedCohort_icon" title="Mandated PLSP cohort details where applicable" border="0" alt="Mandated PLSP Cohort" src="images/icon_info.gif"></th>
 
                        <th>Learning Plan&nbsp;<img onclick="javascript:alert('Learning Plan - PLP or PLSP');return false;" id="LAstudentLearningPlan_icon" title="Learning Plan - PLP or PLSP" border="0" alt="Learning Plan - PLP or PLSP" src="images/icon_info.gif"></th>
...
STATUS</asp:LinkButton> 
                        ...
                        <th>&nbsp;Mandated Cohort&nbsp;<img onclick="javascript:alert('Mandated PLSP cohort details where applicable');return false;" id="SSstudentMandatedCohort_icon" title="Mandated PLSP cohort details where applicable" border="0" alt="Mandated PLSP Cohort" src="images/icon_info.gif"></th>
 
                        <th>Learning Plan&nbsp;<img onclick="javascript:alert('Learning Plan - PLP or PLSP');return false;" id="SSstudentLearningPlan_icon" title="Learning Plan - PLP or PLSP" border="0" alt="Learning Plan - PLP or PLSP" src="images/icon_info.gif"></th>
