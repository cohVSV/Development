...
Namespace DECV_PROD2007.services.StudentDetails_maintain_STUDENT_txtSearch_AttendingSchool_PTAutoFill1 'Namespace @1-6A241511

'Forms Definition @1-C5540E25
Public Class [StudentDetails_maintain_STUDENT_txtSearch_AttendingSchool_PTAutoFill1Page]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-C7552A1B
    ...
    Protected StudentDetails_maintain_STUDENT_txtSearch_AttendingSchool_PTAutoFill1ContentMeta As String
'End Forms Objects
...
'Grid SCHOOL ItemDataBound event @2-05EA4181
...
'OnInit Event Body @1-B7F87540
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        StudentDetails_maintain_STUDENT_txtSearch_AttendingSchool_PTAutoFill1ContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
