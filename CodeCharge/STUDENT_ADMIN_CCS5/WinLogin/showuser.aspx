...
Sub Page_Load()
  ...
  If User.Identity.IsAuthenticated Then
    ...
    displayCredentials.InnerHtml = "Current User : <b>" & User.Identity.Name & "</b>" & _
		" short version: [" &User.Identity.Name.replace("DECV\", "")&"]" & _
	   "<br><br>Authentication Used : <b>" & User.Identity.AuthenticationType & "</b>"& _
       "<br><br>Authenticated? : <b>" & User.Identity.IsAuthenticated & "</b>"
  Else
