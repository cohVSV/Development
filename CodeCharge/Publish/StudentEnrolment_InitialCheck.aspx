...
<table cellspacing="0" cellpadding="0" width="50%" align="center" border="0">
    <tr>
        <td valign="top">
            ...
            <table class="Grid" cellspacing="0" cellpadding="0">
                <tr class="Row">
                    <td colspan="7"><asp:Literal id="STUDENTlblWarningExistingStudent" runat="server"/></td>
                </tr>
  ...
  <asp:PlaceHolder id="NoRecords" visible="False" runat="server">
                ...
                <tr class="NoRecords">
                    <td colspan="7">Student Not Previously Enrolled&nbsp;&nbsp;<a id="STUDENTlink_AddNewStudent" href="" runat="server"  >Add New Student</a></td>
                </tr>
