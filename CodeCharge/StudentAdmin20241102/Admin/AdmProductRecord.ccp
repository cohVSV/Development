...
WHERE product_id={product_id}">
					<Components>
						...
						<ListBox id="36" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Integer" returnValueType="Number" name="category_id" fieldSource="category_id" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Category Id" caption="Category" required="True" connection="InternetDB" wizardEmptyCaption="Select Value" dataSource="store_categories" boundColumn="category_id" textColumn="category_name" PathID="Contentstore_productscategory_id">
							<Components/>
							<Events/>
							<TableParameters/>
							<SPParameters/>
						...
						<CheckBox id="42" visible="Yes" fieldSourceType="DBColumn" dataType="Boolean" name="is_recommended" fieldSource="is_recommended" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Is Recommended" PathID="Contentstore_productsis_recommended" defaultValue="Unchecked">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
