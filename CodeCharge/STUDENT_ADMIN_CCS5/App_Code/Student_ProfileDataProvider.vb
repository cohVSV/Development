...
'Record STUDENT_PROFILE1 Item Class @3-0D5B56E2
Public Class STUDENT_PROFILE1Item
    ...
    Public SUPPORT_DOCS_PRATITIONER_REFERRAL As TextField
    Public SUPPORT_DOCS_PRATITIONER_REFERRALCheckedValue As TextField
    Public SUPPORT_DOCS_PRATITIONER_REFERRALUncheckedValue As TextField
    ...
    SUPPORT_DOCS_PRATITIONER_REFERRAL = New TextField("", "N")
    SUPPORT_DOCS_PRATITIONER_REFERRALCheckedValue = New TextField("", "Y")
    SUPPORT_DOCS_PRATITIONER_REFERRALUncheckedValue = New TextField("", "N")
    ...
    Public Shared Function CreateFromHttpRequest() As STUDENT_PROFILE1Item
        ...
        End If
        End If 
        If Not IsNothing(DBUtility.GetInitialValue("SUPPORT_DOCS_PRATITIONER_REFERRAL")) Then
        If Not IsNothing(System.Web.HttpContext.Current.Request("SUPPORT_DOCS_PRATITIONER_REFERRAL")) Then
            item.SUPPORT_DOCS_PRATITIONER_REFERRAL.Value = item.SUPPORT_DOCS_PRATITIONER_REFERRALCheckedValue.Value
        End If
        End If 
    ...
    Default Public Property Field(fieldName As String) As FieldBase
        Get
            Select fieldName
                ...
                Case "SUPPORT_DOCS_PRATITIONER_REFERRAL"
                    Return SUPPORT_DOCS_PRATITIONER_REFERRAL
        ...
        Set (ByVal Value As FieldBase)
            Select fieldName
                ...
                Case "SUPPORT_DOCS_PRATITIONER_REFERRAL"
                    SUPPORT_DOCS_PRATITIONER_REFERRAL = CType(value, TextField)
                Case "SUPPORT_DOCS_SCHOOL_REFERRAL"
...
'TextArea PATHWAYS_CAREER_GOALS Event OnValidate. Action Validate Maximum Length @164-5DC3215C
        If Not (PATHWAYS_CAREER_GOALS.Value Is Nothing) AndAlso PATHWAYS_CAREER_GOALS.Value.ToString().Length > 400 Then
            errors.Add("PATHWAYS_CAREER_GOALS",String.Format("<span class='errormsg'> Input cannot exceed 400 characters</span>","PATHWAYS CAREER GOALS","400"))
        End If
...
'Record STUDENT_PROFILE1 Build insert @3-E3C1D2F6
        ...
        End If
        If Not item.SUPPORT_DOCS_PRATITIONER_REFERRAL.IsEmpty Then
        allEmptyFlag = item.SUPPORT_DOCS_PRATITIONER_REFERRAL.IsEmpty And allEmptyFlag
        fieldsList = fieldsList & "SUPPORT_DOCS_PRATITIONER_REFERRAL,"
        valuesList = valuesList & Insert.Dao.ToSql(item.SUPPORT_DOCS_PRATITIONER_REFERRAL.GetFormattedValue(""),FieldType._Text) & ","
        End If
...
'Record STUDENT_PROFILE1 BeforeBuildUpdate @3-90C46A33
		Dim valuesList As String = ""
		Dim allEmptyFlag As Boolean= True
        ...
        If Not item.SUPPORT_DOCS_PRATITIONER_REFERRAL.IsEmpty Then
        allEmptyFlag = item.SUPPORT_DOCS_PRATITIONER_REFERRAL.IsEmpty And allEmptyFlag
        valuesList = valuesList & "SUPPORT_DOCS_PRATITIONER_REFERRAL=" + Update.Dao.ToSql(item.SUPPORT_DOCS_PRATITIONER_REFERRAL.GetFormattedValue(""),FieldType._Text) & ","
        End If
        If Not item.SUPPORT_DOCS_SCHOOL_REFERRAL.IsEmpty Then
        allEmptyFlag = item.SUPPORT_DOCS_SCHOOL_REFERRAL.IsEmpty And allEmptyFlag
...
'Record STUDENT_PROFILE1 AfterExecuteSelect @3-611A6114
                If Not IsNothing(E) Then Throw E
        End Try
        End If
        If (Not IsInsertMode) AndAlso (Not ReadNotAllowed) AndAlso dr.Count <> 0 Then
            ...
            item.SUPPORT_DOCS_PRATITIONER_REFERRAL.SetValue(dr(i)("SUPPORT_DOCS_PRATITIONER_REFERRAL"),"")
...
'ListBox COMM_CONTACT_TYPE AfterExecuteSelect @31-9CE4231C
...
item.COMM_CONTACT_TYPEItems.Add("Skype","Skype")
