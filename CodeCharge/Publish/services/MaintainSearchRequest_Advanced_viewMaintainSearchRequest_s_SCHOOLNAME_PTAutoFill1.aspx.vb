...
Namespace DECV_PROD2007.services.MaintainSearchRequest_Advanced_viewMaintainSearchRequest_s_SCHOOLNAME_PTAutoFill1 'Namespace @1-43CD8982

'Forms Definition @1-29EA5286
Public Class [MaintainSearchRequest_Advanced_viewMaintainSearchRequest_s_SCHOOLNAME_PTAutoFill1Page]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-686FD60C
    ...
    Protected MaintainSearchRequest_Advanced_viewMaintainSearchRequest_s_SCHOOLNAME_PTAutoFill1ContentMeta As String
'End Forms Objects
...
'Grid SCHOOL Table Parameters @2-8DAF8C56

    Protected Sub SCHOOLParameters()
        Try
            SCHOOLData.Urlkeyword = TextParameter.GetParam("keyword", ParameterSourceType.URL, "", Nothing, false)
...
'Grid SCHOOL ItemDataBound event @2-58735813
    ...
    Protected Sub SCHOOLItemDataBound(Sender as Object, e as RepeaterItemEventArgs)
        ...
        End If
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            Dim SCHOOLSCHOOL_ID As System.Web.UI.WebControls.Literal = DirectCast(e.Item.FindControl("SCHOOLSCHOOL_ID"),System.Web.UI.WebControls.Literal)
...
'OnInit Event Body @1-D3EB7AEC
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        MaintainSearchRequest_Advanced_viewMaintainSearchRequest_s_SCHOOLNAME_PTAutoFill1ContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
