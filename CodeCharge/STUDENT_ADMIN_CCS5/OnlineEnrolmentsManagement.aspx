<!--ASPX page @1-A36BAD2E-->
    <%@ Page language="vb" CodeFile="OnlineEnrolmentsManagement.aspx.vb" AutoEventWireup="false" Inherits="DECV_PROD2007.OnlineEnrolmentsManagement.OnlineEnrolmentsManagementPage"  ResponseEncoding ="windows-1252"%>
	
	<%@ Import namespace="DECV_PROD2007.OnlineEnrolmentsManagement" %>
...
<title>Online Enrolments Management</title>
