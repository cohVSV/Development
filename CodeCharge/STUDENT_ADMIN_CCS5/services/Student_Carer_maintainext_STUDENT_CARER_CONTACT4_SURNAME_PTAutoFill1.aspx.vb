...
'Forms Definition @1-43629D08
Public Class [Student_Carer_maintainext_STUDENT_CARER_CONTACT4_SURNAME_PTAutoFill1Page]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-9CD789C6
    ...
    Protected Student_Carer_maintainext_STUDENT_CARER_CONTACT4_SURNAME_PTAutoFill1ContentMeta As String
'End Forms Objects
...
'Grid STUDENT_CARER_CONTACT5 Table Parameters @2-6EC7DA94

    Protected Sub STUDENT_CARER_CONTACT5Parameters()
        Try
            STUDENT_CARER_CONTACT5Data.Urlkeyword = TextParameter.GetParam("keyword", ParameterSourceType.URL, "", Nothing, false)
...
'Grid STUDENT_CARER_CONTACT5 ItemDataBound event @2-21F83778
    ...
    Protected Sub STUDENT_CARER_CONTACT5ItemDataBound(Sender as Object, e as RepeaterItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim STUDENT_CARER_CONTACT5LAST_ALTERED_BY As System.Web.UI.WebControls.Literal = DirectCast(e.Item.FindControl("STUDENT_CARER_CONTACT5LAST_ALTERED_BY"),System.Web.UI.WebControls.Literal)
            Dim STUDENT_CARER_CONTACT5LAST_ALTERED_DATE As System.Web.UI.WebControls.Literal = DirectCast(e.Item.FindControl("STUDENT_CARER_CONTACT5LAST_ALTERED_DATE"),System.Web.UI.WebControls.Literal)
        End If
...
'OnInit Event Body @1-01110488
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        Student_Carer_maintainext_STUDENT_CARER_CONTACT4_SURNAME_PTAutoFill1ContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
