...
Namespace DECV_PROD2007.services.CollectAddressDetails 'Namespace @1-6B0FD032

'Forms Definition @1-334E1AA5
Public Class [CollectAddressDetailsPage]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-6937825A
    ...
    Protected CollectAddressDetailsContentMeta As String
'End Forms Objects
...
'Grid ADDRESS Table Parameters @2-8DAFFD80

    Protected Sub ADDRESSParameters()
        Try
            ADDRESSData.UrlADDRESS_ID = FloatParameter.GetParam("ADDRESS_ID", ParameterSourceType.URL, "", Nothing, false)
...
'OnInit Event Body @1-D34B1C0F
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        CollectAddressDetailsContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
