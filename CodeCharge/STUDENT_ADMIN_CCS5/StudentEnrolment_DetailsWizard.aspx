...
<p align="center">
    <asp:Wizard ID="Wizard_AddStudent" runat="server" ActiveStepIndex="0" Width="80%" Font-Bold="False"  FinishCompleteButtonText="Commit Enrolment" CellPadding="2" TabIndex="13">
        <WizardSteps>
            <asp:WizardStep runat="server" Title="Student Details">
                <strong>Student Details<br />
                </strong>
                <asp:ValidationSummary ID="ValidationSummary_Step1" runat="server" HeaderText="The following errors were found, and you cannot continue until they are fixed:"
                    ShowMessageBox="True" />
                <br />
                <table width="100%" cellpadding="2">
                    ...
                    <tr>
                        <td style="height: 18px; text-align: right; width: 165px;">
                            <div class="required">* Gender:</div></td>
                        <td valign="middle">
                            <asp:RadioButtonList ID="radioSex" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" TabIndex="7">
                                <asp:ListItem Value="F">Female</asp:ListItem>
                                <asp:ListItem Value="M">Male</asp:ListItem>
                            </asp:RadioButtonList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="radioSex"
                                ErrorMessage="Gender is Required" Font-Bold="True">Required</asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="height: 18px">
                            <asp:TextBox ID="txtEnrolmentYear" runat="server" Columns="5" TabIndex="9"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="height: 18px;" colspan="2">
                            <asp:TextBox ID="txtRegionCode" runat="server" Columns="6" TabIndex="10" onblur="javascript:getStudentRegionDetails(this);" ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="height: 18px;" colspan="1">
                            <asp:DropDownList ID="listRegion" runat="server" DataSourceID="SqlDataSource_Regions" DataTextField="region_name_display" DataValueField="REGION_ID" TabIndex="11" AppendDataBoundItems="True">
                                <asp:ListItem Selected="True"></asp:ListItem>
                            </asp:DropDownList>
...
LN: 25/11/2013
                    ...
                    <tr>
                        ...
                        <td style="height: 18px; width: 180px;">
                            <asp:DropDownList ID="listCategory" runat="server" DataSourceID="SqlDataSource_Category"
                                DataTextField="SUBCATEGORY_FULL_TITLE" DataValueField="CATSUBCAT_VALUE" TabIndex="13" AppendDataBoundItems="True">
                                <asp:ListItem Selected="True"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                ...
                <table width="100%" cellpadding="2">
                    <tr>
                        ...
                        <td style="width: 524px">
                            <asp:TextBox ID="txtAttendingSchoolName" runat="server" Columns="50">DISTANCE EDUCATION CENTRE</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="height: 26px; width: 524px;">
                            <asp:TextBox ID="txtHomeSchoolName" runat="server" Columns="50">DISTANCE EDUCATION CENTRE</asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <asp:WizardStep runat="server" Title="Address">
                ...
                <asp:ValidationSummary ID="ValidationSummary_Address1" runat="server" HeaderText="Check the following errors with &lt;b&gt;Postal&lt;/b&gt; Address:"
                    ValidationGroup="ValidationSummary_Address1" />
                <br />
                <table width="100%">
					...
					<tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RequiredFieldValidatortxtStudentEmail2" runat="server" ErrorMessage="Student Contact E-mail is not a valid email"
                                Font-Bold="True" ControlToValidate="txtStudentEmail" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$" />
                        </td>
                        <td>
                        </td>
                        <td style="width: 5px">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Postcode is Required"
                                Font-Bold="True" ValidationGroup="ValidationSummary_Address1" ControlToValidate="txtpostcode_1">Required</asp:RequiredFieldValidator>
                        </td>
                        <td style="height: 18px; text-align: right">
                ...
                <asp:ValidationSummary ID="ValidationSummary_Address2" runat="server" HeaderText="Check the following errors with &lt;b&gt;Current&lt;/b&gt; Address"
                    ValidationGroup="ValidationSummary_Address2" />
                <br />
                <table width="100%">
                    <tr>
                        <td>
...
--%>                    <tr>
                ...
                <asp:ValidationSummary ID="ValidationSummary_Address3" runat="server" HeaderText="Check the following errors with &lt;b&gt;Original&lt;/b&gt; Address"
                    ValidationGroup="ValidationSummary_Address3" />
                <br />
                <table width="100%">
                    <tr>
                        <td>
