...
'ListBox STAFF_ID Event BeforeShow. Action Custom Code @121-73254650
    ' -------------------------
     ...
     Dim aSpecialModules() As Integer = {921, 922, 923, 931, 932, 933}    ' Subject ID of Primary Units 10-18 - MUST BE SORTED Ascending
     Dim iSubjectID As Integer = Convert.ToInt32(item.subject_id.getformattedvalue)

     If (Array.IndexOf(aSpecialModules, iSubjectID) > 0) Then
