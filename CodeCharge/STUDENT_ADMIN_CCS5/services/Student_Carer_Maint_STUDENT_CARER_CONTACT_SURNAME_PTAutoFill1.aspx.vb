...
'Forms Definition @1-1F4E41EE
Public Class [Student_Carer_Maint_STUDENT_CARER_CONTACT_SURNAME_PTAutoFill1Page]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-E95C3779
    ...
    Protected Student_Carer_Maint_STUDENT_CARER_CONTACT_SURNAME_PTAutoFill1ContentMeta As String
'End Forms Objects
...
'Grid STUDENT_CARER_CONTACT1 Table Parameters @2-3E78D2C8

    Protected Sub STUDENT_CARER_CONTACT1Parameters()
        Try
            STUDENT_CARER_CONTACT1Data.Expr146 = TextParameter.GetParam("SS", ParameterSourceType.Expression, "", Nothing, false)
            STUDENT_CARER_CONTACT1Data.Urlkeyword = TextParameter.GetParam("keyword", ParameterSourceType.URL, "", Nothing, false)
...
'Grid STUDENT_CARER_CONTACT1 ItemDataBound event @2-27536A37
    ...
    Protected Sub STUDENT_CARER_CONTACT1ItemDataBound(Sender as Object, e as RepeaterItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim STUDENT_CARER_CONTACT1RELATIONSHIP As System.Web.UI.WebControls.Literal = DirectCast(e.Item.FindControl("STUDENT_CARER_CONTACT1RELATIONSHIP"),System.Web.UI.WebControls.Literal)
...
'OnInit Event Body @1-BEE80300
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        Student_Carer_Maint_STUDENT_CARER_CONTACT_SURNAME_PTAutoFill1ContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
