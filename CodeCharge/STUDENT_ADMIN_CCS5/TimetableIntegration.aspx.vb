...
Namespace DECV_PROD2007.TimetableIntegration 'Namespace @1-1793B621

'Forms Definition @1-8DA20CA3
Public Class [TimetableIntegrationPage]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-662B1023
...
'OnInit Event Body @1-DBB699C1
        ...
        InitializeComponent()
        MyBase.OnInit(e)
        If Not(DBUtility.AuthorizeUser(New String(){"3","7","9"})) Then
