...
'Record Form STUDENT_PROFILE1 BeforeShow tail @3-B70ACE2E
        ...
        End If
        If item.SUPPORT_DOCS_PRATITIONER_REFERRALCheckedValue.Value.Equals(item.SUPPORT_DOCS_PRATITIONER_REFERRAL.Value) Then
            STUDENT_PROFILE1SUPPORT_DOCS_PRATITIONER_REFERRAL.Checked = True
        End If
...
'Record Form STUDENT_PROFILE1 LoadItemFromRequest method @3-78C48F6C
    ...
    Protected Sub STUDENT_PROFILE1LoadItemFromRequest(item As STUDENT_PROFILE1Item, ByVal EnableValidation As Boolean)
        ...
        End If
        If STUDENT_PROFILE1SUPPORT_DOCS_PRATITIONER_REFERRAL.Checked Then
            item.SUPPORT_DOCS_PRATITIONER_REFERRAL.Value = (item.SUPPORT_DOCS_PRATITIONER_REFERRALCheckedValue.Value)
        Else
            item.SUPPORT_DOCS_PRATITIONER_REFERRAL.Value = (item.SUPPORT_DOCS_PRATITIONER_REFERRALUncheckedValue.Value)
        End If
...
'Record Form STUDENT_PROFILE1 ShowErrors method @3-B9614FAE
