...
'Grid ADDRESS Data Provider Class Variables @2-63A09B00
...
'Grid ADDRESS Data Provider Class GetResultSet Method @2-06D9340F

    Public Sub New()
        Select_=new TableCommand("SELECT TOP {SqlParam_endRecord} * " & vbCrLf & _
          "FROM ADDRESS {SQL_Where} {SQL_OrderBy}", New String(){"ADDRESS_ID153"},Settings.connDECVPRODSQL2005DataAccessObject )
        Count=new TableCommand("SELECT COUNT(*)" & vbCrLf & _
          "FROM ADDRESS", New String(){"ADDRESS_ID153"},Settings.connDECVPRODSQL2005DataAccessObject , true)
    End Sub
...
'Before build Select @2-52D79F7D
        Dim E as Exception = Nothing
        Select_.Parameters.Clear()
        CType(Select_,TableCommand).AddParameter("ADDRESS_ID153",UrlADDRESS_ID, "","ADDRESS_ID",Condition.Equal,False)
