...
<asp:TextBox id="STUDENT_PROFILE1EXPECT_RETURN_TO_SCHOOL" rows="3" Columns="50" maxysize="400" TextMode="MultiLine"	runat="server"/>
          ...
          <tr class="Controls">
            <th>Previously known to Pathways? * 
            <div class="errormsg">
          ...
          <tr class="Controls">
            ...
            <td>&nbsp; 
              <div class="instructions">
                * if answered Yes to Wellbeing,Inclusion or Pathways, consult with personnel from relevant area<br>
              </div>
            </td>
          </tr>
          ...
          <tr class="Controls">
            <th>
            <p>LIST OF SUPPORTING DOCUMENTATION 
            <div class="errormsg">
            ...
            <td><asp:CheckBox id="STUDENT_PROFILE1SUPPORT_DOCS_AGENCY_REFERRAL" runat="server"/>&nbsp;Agency Referral Form<br>
              <br>
              <asp:CheckBox id="STUDENT_PROFILE1SUPPORT_DOCS_PRATITIONER_REFERRAL" runat="server"/>&nbsp;Practitioner Referral Form <br>
              <br>
              <asp:CheckBox id="STUDENT_PROFILE1SUPPORT_DOCS_SCHOOL_REFERRAL" runat="server"/>&nbsp;School Referral Form <br>
              <br>
              <asp:CheckBox id="STUDENT_PROFILE1SUPPORT_DOCS_YOUNG_ADULT" runat="server"/>&nbsp;Young Adult form <br>
              <br>
              Other <asp:TextBox id="STUDENT_PROFILE1SUPPORT_DOCS_OTHER" maxlength="50" Columns="35"	runat="server"/></td>
          </tr>
          ...
          <tr class="Controls">
            ...
            <td><strong>Support 1</strong><br>
              NAME <asp:TextBox id="STUDENT_PROFILE1SUPPORT_KEY_PROFESSIONAL_NAME" maxlength="50" Columns="50"	runat="server"/><br>
              ...
              NAME <asp:TextBox id="STUDENT_PROFILE1SUPPORT_KEY_PROFESSIONAL_NAME2" maxlength="50" Columns="50"	runat="server"/><br>
              CONTACT <asp:TextBox id="STUDENT_PROFILE1SUPPORT_KEY_PROFESSIONAL_CONTACT2" maxlength="50" Columns="50"	runat="server"/></td>
          </tr>
...
<asp:TextBox id="STUDENT_PROFILE1ENGAGEMENT_HOBBIES_INTERESTS" rows="3" Columns="50" maxysize="400" TextMode="MultiLine"	runat="server"/>
          ...
          <tr class="Controls">
            <th>
            <p>A VSV/Student visit has been undertaken? 
            <div class="errormsg">
            ...
            <td>
              ...
              <br>
              Visit Date (if done): <asp:TextBox id="STUDENT_PROFILE1COMM_VISIT_DATE" maxlength="10" Columns="10"	runat="server"/>&nbsp;<em>dd/mm/yyyy format</em></td>
          </tr>
          ...
          <tr class="Controls">
            ...
            <td>
              <div class="instructions">
                Frequency, timing and method of contact negotiated with student and parent/carer (fortnightly minimum requirement) 
              </div>
...
<asp:TextBox id="STUDENT_PROFILE1COMM_CONTACT_TYPE_OTHER" rows="5" Columns="50" maxysize="200" TextMode="MultiLine"	runat="server"/>
          ...
          <tr class="Controls">
            <th>CARER PREFERRED CONTACT METHOD 
            <div class="instructions">
              (Outside minimum fortnightly phone call) 
            </div>
...
<asp:TextBox id="STUDENT_PROFILE1ORGANISATION_PREVIOUS_SCHOOL" rows="4" Columns="50" maxysize="200" TextMode="MultiLine"	runat="server"/>
          ...
          <tr class="Controls">
            ...
            <div class="instructions">
              ...
              AusVELS assessments, NAPLAN data if available 
            </div>
...
<asp:TextBox id="STUDENT_PROFILE1SPECIAL_PROVISION_DETAILS" rows="3" Columns="50" maxysize="400" TextMode="MultiLine"	runat="server"/>
          ...
          <tr class="Controls">
            <th>SUMMARY OF FUTURE CAREER GOALS 
            <div class="errormsg">
            ...
            <td>
<asp:TextBox id="STUDENT_PROFILE1PATHWAYS_CAREER_GOALS" rows="3" Columns="50" maxysize="400" TextMode="MultiLine"	runat="server"/>
</td>
          </tr>
