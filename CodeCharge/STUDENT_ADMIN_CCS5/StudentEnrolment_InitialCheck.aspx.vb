...
'Record Form STUDENTSearch BeforeShow tail @10-6A4CAECA
...
'Record Form STUDENTSearch LoadItemFromRequest method @10-6F8A8666
...
'Button Button_DoSearch OnClick. @11-977BF6BD
        If CType(sender,Control).ID = "STUDENTSearchButton_DoSearch" Then
            RedirectUrl = GetSTUDENTSearchRedirectUrl("", "s_SURNAME;s_FIRST_NAME;s_BIRTH_DATE;s_STUDENT_ID")
...
'Record Form STUDENTSearch Search Operation tail @10-11CBC18C
        ErrorFlag = STUDENTSearchErrors.Count > 0
        If ErrorFlag Then
            STUDENTSearchShowErrors()
        Else
...
'Grid Form STUDENT BeforeShow tail @3-E91528B5
        STUDENTParameters()
...
'Grid STUDENT Table Parameters @3-A4485069
...
'Grid STUDENT ItemDataBound event @3-225CE05F
