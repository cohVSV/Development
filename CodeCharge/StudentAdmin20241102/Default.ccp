<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="False" urlType="Relative" SSLAccess="False" validateRequest="False" needGeneration="0" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" isService="False" scriptingSupport="Automatic" isIncluded="False" useDesign="True" oldWizardTheme="Basic" masterPage="{CCS_PathToMasterPage}/MasterPage.ccp" showSyncDlg="false">
	<Components>
	...
	<CodeFiles>
		...
		<CodeFile id="Events" language="PHPTemplates" name="Default_events.php" forShow="False" comment="//"/>
</CodeFiles>
	<SecurityGroups/>
	<Events>
<Event name="AfterInitialize" type="Server">
<Actions>
<Action actionName="Logout" actionCategory="Security" id="283" pageRedirects="True" parameterName="Logout" returnPage="Default.ccp"/>
</Actions>
</Event>
</Events>
	<CachingParameters/>
