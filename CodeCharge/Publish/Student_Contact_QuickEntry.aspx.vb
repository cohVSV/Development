...
'Page_Load Event BeforeIsPostBack @1-910EE26F
...
'Record Form QuickEnterForm Parameters @4-DD45FA37
...
'Record Form QuickEnterForm Show method @4-FC85FC64
...
'Record Form QuickEnterForm BeforeShow tail @4-C43919BC
        ...
        QuickEnterFormLAST_ALTERED_DATE.Value = item.LAST_ALTERED_DATE.GetFormattedValue()
...
'Record QuickEnterForm Event BeforeShow. Action Retrieve Value for Control @21-876C3209
            QuickEnterFormLAST_ALTERED_BY.Value = (New TextField("", (DBUtility.UserLogin.ToUpper))).GetFormattedValue()
'End Record QuickEnterForm Event BeforeShow. Action Retrieve Value for Control
...
'Record Form QuickEnterForm LoadItemFromRequest method @4-20AC899D
    ...
    Protected Sub QuickEnterFormLoadItemFromRequest(item As QuickEnterFormItem, ByVal EnableValidation As Boolean)
        ...
        Try
        item.LAST_ALTERED_DATE.IsEmpty = IsNothing(Request.Form(QuickEnterFormLAST_ALTERED_DATE.UniqueID))
        item.LAST_ALTERED_DATE.SetValue(QuickEnterFormLAST_ALTERED_DATE.Value)
        Catch ae As ArgumentException
            QuickEnterFormErrors.Add("LAST_ALTERED_DATE",String.Format(Resources.strings.CCS_IncorrectFormat,"LAST ALTERED DATE","dd/mm/yyyy"))
        End Try
...
'Record QuickEnterForm Event BeforeInsert. Action Retrieve Value for Control @13-57DF577E
        QuickEnterFormLAST_ALTERED_DATE.Value = (New DateField(Settings.DateFormat, (Now()))).GetFormattedValue()
'End Record QuickEnterForm Event BeforeInsert. Action Retrieve Value for Control
