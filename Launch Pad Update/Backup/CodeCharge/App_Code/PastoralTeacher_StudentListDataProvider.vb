...
'EditableGrid viewMaintainSearchRequest1 Data Provider Class Constructor @51-F096B380
    ...
    Public Sub New()
        Select_=new SqlCommand("select" & vbCrLf & _
          ...
          "    select" & vbCrLf & _
          "       st.*," & vbCrLf & _
          "       iif((smd.PSD_FUNDING_ELIGIBLE = 'true') or (substring(smd.PSD_FUNDING_CATEGORY, 3, " & _
          "10) <> '')," & vbCrLf & _
          "       'PSD Funded; '," & vbCrLf & _
          "       '') as PSDFunded," & vbCrLf & _
          "       iif((smd.NCCD_FUNDING_APPROVED = 'true') or (smd.NCCD_FUNDING_CATEGORY is not null)" & _
          ", 'NCCD Funded; ', '') as NCCDFunded," & vbCrLf & _
          "       iif(scd.HOUSEHOLD_STATUS in (3, 6, 7), concat(vhs.HouseholdStatusDisplayText, '; ')" & _
          ", '') as HouseholdStatus," & vbCrLf & _
          "       iif(scd.KOORITORRESFLAG <> 'N', 'Indigenous; ', '') as ATSIStatus," & vbCrLf & _
          "       iif(eas.YouthJustice = 'true', 'Youth Justice; ', '') as YouthJustice," & vbCrLf & _
...
'EditableGrid viewMaintainSearchRequest1 BeforeBuildUpdate @51-2734D932
        ...
        Update.Parameters.Add("expr132","(SUBJECT_ID not in (921,922,923,924,931,932,933) )")
...
'EditableGrid viewMaintainSearchRequest2 Data Provider Class Constructor @161-976FB5D9
    ...
    Public Sub New()
        Select_=new SqlCommand("select" & vbCrLf & _
          ...
          "       (" & vbCrLf & _
          "          select" & vbCrLf & _
          "             ss.STUDENT_ID," & vbCrLf & _
          "             ss.ENROLMENT_YEAR," & vbCrLf & _
          "             count(*) as SubjectCount" & vbCrLf & _
          "           from" & vbCrLf & _
          "             dbo.STUDENT_SUBJECT as ss" & vbCrLf & _
          "           where" & vbCrLf & _
          "             (ss.SUBJ_ENROL_STATUS in ('C', 'D'))" & vbCrLf & _
          ...
          "       ) as ssc" & vbCrLf & _
          "          on (" & vbCrLf & _
          "                (ssc.STUDENT_ID = vw.STUDENT_ID)" & vbCrLf & _
          "                and (ssc.ENROLMENT_YEAR = vw.ENROLMENT_YEAR)" & vbCrLf & _
          "             )" & vbCrLf & _
          "       left join dbo.EARLY_ASSESSMENT_STUDENT as eas" & vbCrLf & _
          "          on (" & vbCrLf & _
          ...
          "       and (ssc.SubjectCount = 1)" & vbCrLf & _
          "       and exists" & vbCrLf & _
          "     (" & vbCrLf & _
          "        select" & vbCrLf & _
          "           *" & vbCrLf & _
...
'EditableGrid viewMaintainSearchRequest2 BeforeBuildUpdate @161-DA050627
		Dim valuesList As String = ""
		Dim allEmptyFlag As Boolean= True
        ...
        Update.Parameters.Add("expr232","(SUBJECT_ID not in (921,922,923,924,931,932,933) )")
        allEmptyFlag = item.rbGreenLetterSend.IsEmpty And allEmptyFlag
        If Not item.rbGreenLetterSend.IsEmpty Then
        If IsNothing(item.rbGreenLetterSend.Value) Then
        valuesList = valuesList & "DEFAULTING_STATUS=" & Update.Dao.ToSql(Nothing,FieldType._Text) & ","
