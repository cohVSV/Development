'SingleParameter Class @0-B553556E
...
Namespace DECV_PROD2007.Data
   ...
   Public Class SingleParameter
      ...
      Public Sub New()
         MyClass.New([Single].NaN, "", "")
      End Sub 'New
      
      
      Public Sub New(format As String)
         MyClass.New([Single].NaN, format, "")
      End Sub 'New
      
      
      Public Sub New(format As String, dbFormat As String)
         MyClass.New([Single].NaN, format, dbFormat)
      End Sub 'New
      ...
      Public Sub New(Value As [Single], format As String)
         MyClass.New(Value, format, "")
      End Sub 'New
      
      
      Public Sub New(Value As [Single], format As String, dbFormat As String)
         Me.Value = Value
         Format = format
         DbFormat = dbFormat
      End Sub 'New
      ...
      Private Shared Function GetTypedVal(val As Object, format As String) As [Single]
      ...
      Overloads Public Shared Function GetParam(param As Object, defaultValue As Object) As SingleParameter
         Return GetParam(param, "", defaultValue)
      End Function 'GetParam
      
      
      Overloads Public Shared Function GetParam(param As Object) As SingleParameter
         Return GetParam(param, "", Nothing)
      End Function 'GetParam
      
      
      Overloads Public Shared Function GetParam(param As Object, format As String) As SingleParameter
         Return GetParam(param, format, Nothing)
      End Function 'GetParam
      
      
      Overloads Public Shared Function GetParam(param As Object, format As String, defaultValue As Object) As SingleParameter
         Return GetParam(param, ParameterSourceType.Expression, format, defaultValue, False)
      End Function 'GetParam
      
      
      Overloads Public Shared Function GetParam(param As Object, type As ParameterSourceType, format As String, defaultValue As Object, isNullable As Boolean) As SingleParameter
         Dim val As Object = GetParamInternal(param, type)
         
         If val Is Nothing Then
            val = defaultValue
         End If
         Dim p As New SingleParameter()
         If val Is Nothing Then
