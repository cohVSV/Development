			...
			<Components>
				<Record id="28" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="store_editorial_products" connection="InternetDB" dataSource="store_editorial_products" errorSummator="Error" allowCancel="True" recordDeleteConfirmation="False" buttonsType="button" wizardRecordKey="article_id" encryptPasswordField="False" wizardUseInterVariables="False" pkIsAutoincrement="True" wizardCaption="Add/Edit Store Editorial Products " wizardThemeApplyTo="Page" wizardFormMethod="post" wizardType="Record" changedCaptionRecord="False" recordDirection="Custom" templatePageRecord="Templates/Record/SimpleVertical.ccp|userTemplate" PathID="Contentstore_editorial_products" returnPage="AdmEditProducts.ccp" removeParameters="article_id" customDeleteType="SQL" parameterTypeListName="ParameterTypeList" activeCollection="DSQLParameters" customDelete="UPDATE store_editorial_products SET is_active=0 WHERE article_id={article_id}">
					<Components>
						...
						<ListBox id="34" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Integer" returnValueType="Number" name="editorial_cat_id" fieldSource="editorial_cat_id" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Editorial Cat Id" caption="Category" required="True" connection="InternetDB" wizardEmptyCaption="Select Value" dataSource="store_editorial_categories" boundColumn="category_id" textColumn="category_name" PathID="Contentstore_editorial_productseditorial_cat_id">
							<Components/>
							<Events/>
							<TableParameters/>
							<SPParameters/>
						...
						<TextBox id="35" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="article_title" fieldSource="article_title" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Article Title" caption="Title" required="True" unique="False" wizardSize="50" wizardMaxLength="200" PathID="Contentstore_editorial_productsarticle_title">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</TextBox>
						<TextArea id="36" visible="Yes" fieldSourceType="DBColumn" dataType="Memo" name="article_desc" fieldSource="article_desc" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Article Desc" caption="Content" required="False" unique="False" wizardSize="50" wizardRows="3" PathID="Contentstore_editorial_productsarticle_desc">
							<Components/>
							<Events/>
							<Attributes/>
							<Features/>
						</TextArea>
						<ListBox id="37" visible="Yes" fieldSourceType="DBColumn" sourceType="Table" dataType="Integer" returnValueType="Number" name="product_id" fieldSource="product_id" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardCaption="Product Id" caption="Product" required="True" unique="False" connection="InternetDB" wizardEmptyCaption="Select Value" dataSource="store_products" boundColumn="product_id" textColumn="product_name" PathID="Contentstore_editorial_productsproduct_id">
							<Components/>
							<Events/>
							<TableParameters/>
							<SPParameters/>
