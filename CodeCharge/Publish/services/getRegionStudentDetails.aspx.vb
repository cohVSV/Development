...
'Forms Definition @1-EE258099
Public Class [getRegionStudentDetailsPage]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-07ECFE97
    ...
    Protected getRegionStudentDetailsContentMeta As String
'End Forms Objects
...
'Grid tblRegionEnrolments Table Parameters @2-BDFD6D90

    Protected Sub tblRegionEnrolmentsParameters()
        Try
            tblRegionEnrolmentsData.Urlracid = IntegerParameter.GetParam("racid", ParameterSourceType.URL, "", 0, false)
...
'Grid tblRegionEnrolments ItemDataBound event @2-B8A7EB1F
    ...
    Protected Sub tblRegionEnrolmentsItemDataBound(Sender as Object, e as RepeaterItemEventArgs)
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim tblRegionEnrolmentsNotes As System.Web.UI.WebControls.Literal = DirectCast(e.Item.FindControl("tblRegionEnrolmentsNotes"),System.Web.UI.WebControls.Literal)
        End If
...
'OnInit Event Body @1-FC7FC578
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        getRegionStudentDetailsContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
        tblRegionEnrolmentsData = New tblRegionEnrolmentsDataProvider()
        tblRegionEnrolmentsOperations = New FormSupportedOperations( _
	  New GroupRight("9", True, False, False, False), _
	  New GroupRight("6", True, False, False, False), _
	  New GroupRight("4", True, False, False, False), _
	  New GroupRight("3", True, False, False, False))
        If Not(DBUtility.AuthorizeUser(New String(){"3","4","6","9"})) Then
