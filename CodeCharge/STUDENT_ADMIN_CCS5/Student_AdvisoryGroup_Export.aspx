<!--ASPX page @1-2031EBC6-->
    <%@ Page language="vb" CodeFile="Student_AdvisoryGroup_Export.aspx.vb" AutoEventWireup="false" Inherits="DECV_PROD2007.Student_AdvisoryGroup_Export.Student_AdvisoryGroup_ExportPage"  ResponseEncoding ="windows-1252"%>
	
	<%@ Import namespace="DECV_PROD2007.Student_AdvisoryGroup_Export" %>
...
<table cellspacing="0" cellpadding="0" align="center" border="0">
    ...
    <td valign="top">
      <table class="Grid" cellspacing="0" cellpadding="0" border="0">
        <tr class="Caption">
          ...
          <th>School Supervisor Name&nbsp;</th>
 
          <th>School Supervisor Phone&nbsp;</th>
 
          <th>School Supervisor Email&nbsp;</th>
  ...
  <asp:PlaceHolder id="NoRecords" visible="False" runat="server">
        ...
        <tr class="NoRecords">
          <td colspan="21">No Students found for this Teacher and Subject.</td>
        </tr>
