<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\services" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="True" cachingEnabled="False" validateRequest="True" cachingDuration="1 minutes" needGeneration="0" PathID="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" name="ADDRESS" connection="connDECVPRODSQL2005" dataSource="ADDRESS" pageSizeLimit="100" wizardCaption="List of ADDRESS " PathID="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1ADDRESS">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="3" language="VB" name="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1.aspx" forShow="True" url="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1.aspx" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
		<CodeFile id="1" language="VB" name="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1.aspx.vb" forShow="False" comment="'" codePage="windows-1252"/>
		<CodeFile id="2" language="VB" name="Student_Address_maintain_viewStudentMaintain_Addre_PostAdd_SCHOOL_ADDRESS_ID_ifknown_PTAutoFill1DataProvider.vb" path="..\App_Code\.\services" forShow="False" comment="'" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
