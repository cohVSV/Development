...
'Grid SCHOOL Item Class @2-0C045C7C
...
'Grid SCHOOL Data Provider Class Variables @2-F746A423
...
'Grid SCHOOL Data Provider Class GetResultSet Method @2-4FFEAF1E

    Public Sub New()
        Select_=new TableCommand("SELECT TOP {SqlParam_endRecord} SCHOOL_ID, " & vbCrLf & _
          "rtrim(SCHOOL_NAME) AS school_name " & vbCrLf & _
          "FROM SCHOOL {SQL_Where} {SQL_OrderBy}", New String(){"expr38","And","keyword41"},Settings.connDECVPRODSQL2005DataAccessObject )
        Count=new TableCommand("SELECT COUNT(*)" & vbCrLf & _
          "FROM SCHOOL", New String(){"expr38","And","keyword41"},Settings.connDECVPRODSQL2005DataAccessObject , true)
    End Sub
...
'Before build Select @2-ACBAC062
        Dim E as Exception = Nothing
        Select_.Parameters.Clear()
        CType(Select_,TableCommand).AddParameter("keyword41",Urlkeyword, "","school_name",Condition.Equal,False)
        Select_.Parameters.Add("expr38","(STATUS =1)")
...
'After execute Select tail @2-B06178DB
            Dim i as Integer
