...
Namespace DECV_PROD2007.services.Student_ClassList_ExportCSV 'Namespace @1-72B81618

'Forms Definition @1-46A35DF1
Public Class [Student_ClassList_ExportCSVPage]
Inherits CCPage
'End Forms Definition

'Forms Objects @1-CE35BBF9
    ...
    Protected Student_ClassList_ExportCSVContentMeta As String
'End Forms Objects
...
'Page Student_ClassList_ExportCSV Event OnInitializeView. Action Custom Code @197-73254650
    ' -------------------------
    ...
    ' -------------------------
'End Page Student_ClassList_ExportCSV Event OnInitializeView. Action Custom Code
...
'Grid view_Class_Contact_List_0 Bind @2-D3CB81C6
    ...
    Protected Sub view_Class_Contact_List_0Bind()
        ...
        If Not(IsPostBack) Then
            DBUtility.InitializeGridParameters(ViewState,"view_Class_Contact_List_0",GetType(view_Class_Contact_List_0DataProvider.SortFields), 100, 100)
        End If
'End Grid view_Class_Contact_List_0 Bind

'Grid Form view_Class_Contact_List_0 BeforeShow tail @2-25B62327
        view_Class_Contact_List_0Parameters()
...
'Grid view_Class_Contact_List_0 Table Parameters @2-D27108E8

    Protected Sub view_Class_Contact_List_0Parameters()
        Try
            view_Class_Contact_List_0Data.UrlList_Subject_id = IntegerParameter.GetParam("List_Subject_id", ParameterSourceType.URL, "", Nothing, false)
            view_Class_Contact_List_0Data.UrlList_SEMESTER = TextParameter.GetParam("List_SEMESTER", ParameterSourceType.URL, "", Nothing, false)
            view_Class_Contact_List_0Data.UrlList_SUBJECT_ENROL_STATUS = TextParameter.GetParam("List_SUBJECT_ENROL_STATUS", ParameterSourceType.URL, "", Nothing, false)
            view_Class_Contact_List_0Data.Expr195 = TextParameter.GetParam(DBUtility.UserLogin.ToUpper, ParameterSourceType.Expression, "", Nothing, false)

        Catch
            Dim ParentControls As ControlCollection=view_Class_Contact_List_0Repeater.Parent.Controls
            Dim RepeaterIndex As Integer=ParentControls.IndexOf(view_Class_Contact_List_0Repeater)
            ParentControls.RemoveAt(RepeaterIndex)
            Dim ErrorMessage as Literal=New Literal()
            ErrorMessage.Text="Error in Grid view_Class_Contact_List_0: Invalid parameter"
            ParentControls.AddAt(RepeaterIndex,ErrorMessage)
        End Try
    End Sub
'End Grid view_Class_Contact_List_0 Table Parameters
...
'OnInit Event Body @1-472C886D
        ClientScript.GetPostBackEventReference(Me, "")
        Utility.SetThreadCulture()
        PageStyleName = Utility.GetPageStyle()
        Student_ClassList_ExportCSVContentMeta = "text/html; charset=" +  CType(System.Threading.Thread.CurrentThread.CurrentCulture,CCSCultureInfo).Encoding
        InitializeComponent()
        MyBase.OnInit(e)
