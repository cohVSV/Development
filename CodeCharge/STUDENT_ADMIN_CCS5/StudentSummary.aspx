...
<link rel="stylesheet" type="text/css" href="js/tablesort_theme/style.css">
  ...
  <asp:PlaceHolder id="viewStudentSummary_DetailError" visible="False" runat="server">
                            ...
                            <tr class="Controls">
                                ...
                                <td>&nbsp; 
                                    ...
                                    <span id="lblStudentFolderBrowserNotice" style="display: none; margin-top: 5px; font-style: italic">Please try using the Microsoft Edge browser if the folder link doesn't work</span> </td>
                            </tr>
...
<asp:repeater id="Grid_Modified_CommentRepeater" OnItemCommand="Grid_Modified_CommentItemCommand" OnItemDataBound="Grid_Modified_CommentItemDataBound" runat="server">
  <HeaderTemplate>
        ...
        <tr>
            <td valign="top">
                <table class="Header" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td class="HeaderLeft"><img border="0" src="Styles/Blueprint/Images/Spacer.gif"></td> 
                        <th><font color="#ff9900">Modified Subjects or Individual Education Plan&nbsp;Comments (Current Enrolment Year)</font></th>
  ...
  <ItemTemplate>
                    <tr class="Row">
                        <td><asp:Literal id="Grid_Modified_CommentCOMMENT" Text='<%# Server.HtmlEncode((CType(Container.DataItem,Grid_Modified_CommentItem)).COMMENT.GetFormattedValue()).Replace(vbCr,"").Replace(vbLf,"<br>") %>' runat="server"/>&nbsp;</td> 
                        <td><asp:Literal id="Grid_Modified_CommentLAST_ALTERED_BY" Text='<%# Server.HtmlEncode((CType(Container.DataItem,Grid_Modified_CommentItem)).LAST_ALTERED_BY.GetFormattedValue()).Replace(vbCr,"").Replace(vbLf,"<br>") %>' runat="server"/>&nbsp;</td> 
                        <td><asp:Literal id="Grid_Modified_CommentLAST_ALTERED_DATE" Text='<%# Server.HtmlEncode((CType(Container.DataItem,Grid_Modified_CommentItem)).LAST_ALTERED_DATE.GetFormattedValue()).Replace(vbCr,"").Replace(vbLf,"<br>") %>' runat="server"/>&nbsp;</td>
                    </tr>
  ...
  <asp:PlaceHolder id="NoRecords" visible="False" runat="server">
                    ...
                    <tr class="NoRecords">
                        <td colspan="3">No Modified Subject or CLP&nbsp;comments for the current enrolment Year.</td>
                    </tr>
