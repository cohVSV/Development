...
'Record STUDENTSearch Item Class @10-F491099A
...
'Grid STUDENT Item Class @3-2634EDA8
...
'Grid STUDENT Data Provider Class Variables @3-ABA456AF
...
'Grid STUDENT Data Provider Class GetResultSet Method @3-142050AC

    Public Sub New()
        Select_=new TableCommand("SELECT TOP {SqlParam_endRecord} STUDENT_ID, SURNAME, FIRST_NAME, BIRTH_DATE, SEX, " & vbCrLf & _
          "PREFERRED_NAME " & vbCrLf & _
          "FROM STUDENT {SQL_Where} {SQL_OrderBy}", New String(){"(","s_SURNAME84","And","(","s_FIRST_NAME85","Or","s_FIRST_NAME86",")","And","s_BIRTH_DATE87",")","Or","s_STUDENT_ID88"},Settings.connDECVPRODSQL2005DataAccessObject )
        Count=new TableCommand("SELECT COUNT(*)" & vbCrLf & _
          "FROM STUDENT", New String(){"(","s_SURNAME84","And","(","s_FIRST_NAME85","Or","s_FIRST_NAME86",")","And","s_BIRTH_DATE87",")","Or","s_STUDENT_ID88"},Settings.connDECVPRODSQL2005DataAccessObject , true)
    End Sub
...
'Before build Select @3-6DF1C136
        Dim E as Exception = Nothing
        Select_.Parameters.Clear()
        CType(Select_,TableCommand).AddParameter("s_SURNAME84",Urls_SURNAME, "","SURNAME",Condition.Contains,True)
        CType(Select_,TableCommand).AddParameter("s_FIRST_NAME85",Urls_FIRST_NAME, "","FIRST_NAME",Condition.Contains,True)
        CType(Select_,TableCommand).AddParameter("s_FIRST_NAME86",Urls_FIRST_NAME, "","PREFERRED_NAME",Condition.BeginsWith,True)
        CType(Select_,TableCommand).AddParameter("s_BIRTH_DATE87",Urls_BIRTH_DATE, Select_.DateFormat,"BIRTH_DATE",Condition.Equal,False)
        CType(Select_,TableCommand).AddParameter("s_STUDENT_ID88",Urls_STUDENT_ID, "","STUDENT_ID",Condition.Equal,False)
...
'After execute Select tail @3-DFA7F30E
            Dim i as Integer
